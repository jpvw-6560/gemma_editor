...
class MsgToast(QWidget):
    ...
    def __init__(self, title, message, duration=3500, toast_type="default", parent=None):
    ...
    @classmethod
    def info(cls, title, message, duration=3500, parent=None):
        t = cls(title, message, duration, "info", parent)
        t.show_toast()
        return t

    @classmethod
    def success(cls, title, message, duration=3500, parent=None):
        t = cls(title, message, duration, "success", parent)
        t.show_toast()
        return t

    @classmethod
    def warning(cls, title, message, duration=3500, parent=None):
        t = cls(title, message, duration, "warning", parent)
        t.show_toast()
        return t

    @classmethod
    def error(cls, title, message, duration=3500, parent=None):
