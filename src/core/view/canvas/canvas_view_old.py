...
class CanvasView(QGraphicsView):
    ...
    def __init__(self):
        ...
        # Ajouter l'image de fond pour développement
        if AppConfig.SHOW_PDF:
            import os
            base_dir = os.path.dirname(os.path.abspath(__file__))
            fond_path = os.path.abspath(os.path.join(base_dir, '../../core/data/assets/images/GEMMA-fond.png'))
    ...
    def dropEvent(self, event):
        ...
        self.stateDropped.emit(code, label, pos_scene)
